...
- (void)buildLauncherButton {
    ...
    self.launcherButton.titleLabel.font = [UIFont italicSystemFontOfSize:24 weight:UIFontWeightBold];
...
- (void)buildMenu {
    ...
    logo.text = @"77";
    logo.font = [UIFont italicSystemFontOfSize:32 weight:UIFontWeightBold];
...
- (void)buildIntro {
    ...
    label.text = @"Lucky77";
    label.font = [UIFont italicSystemFontOfSize:52 weight:UIFontWeightBold];
